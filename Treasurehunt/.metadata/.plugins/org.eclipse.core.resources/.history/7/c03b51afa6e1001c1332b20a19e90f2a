...
public class Level3 extends JFrame {
	...
	Level3() {
		...
		// 적 랜덤 위치 값 변수에 넣기
		enemy1moveX = ranX(ranX, 0); enemy1moveY = 150;
		enemy2moveX = ranX(ranX, 1); enemy2moveY = 320;
		...
		hole.setBounds(ranX(ranX, 3), 120, 100, 100);
		c.add(hole);
		...
		hole2.setBounds(ranX(ranX, 4), 280, 100, 100);
		c.add(hole2);
		...
		hole3.setBounds(ranX(ranX, 5), 400, 100, 100);
		c.add(hole3);
		...
		TimerTask t3 = new TimerTask() {
			public void run() {
				...
				if (b == true) {
					...
					if ((ay > thief.getY() - 75 && ay < thief.getY() + 75 && ax - 40 > thief.getX() - 60
							&& ax < thief.getX() + 60)) {
						thief.setVisible(false);
						Check4 = false;
						Music.audio2();
					}
					if ((ay > thief2.getY() - 75 && ay < thief2.getY() + 75 && ax - 40 > thief2.getX() - 60
							&& ax < thief2.getX() + 60)) {
				...
				// 우물 들어감 체크
				if ((y > hole.getY() - 60 && y < hole.getY() + 40 && x > hole.getX() - 50 && x < hole.getX() + 80)
						|| (y > hole2.getY() - 60 && y < hole2.getY() + 40 && x > hole2.getX() - 50
								&& x < hole2.getX() + 80)
						|| (y > hole3.getY() - 60 && y < hole3.getY() + 40 && x > hole3.getX() - 50
								&& x < hole3.getX() + 80)) {
				...
				if ((y > thief.getY() - 70 && y < thief.getY() + 70 && x > thief.getX() - 60
						&& x < thief.getX() + 60)) {
					if (Check4 == true) {
						new Failed();
						setVisible(false);
				...
				if ((y > thief2.getY() - 70 && y < thief2.getY() + 70 && x > thief2.getX() - 60
						&& x < thief2.getX() + 60)) {
					if (Check5 == true) {
						new Failed();
						setVisible(false);
