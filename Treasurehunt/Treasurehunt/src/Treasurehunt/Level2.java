...
public class Level2 extends JFrame {
	...
	Level2() {
		...
		enemy3moveX = ranX(ranX, 2); enemy3moveY = 520;
		...
		enemy8moveX = ranX(ranX, 7); enemy8moveY = 470;
		
		System.out.println(enemy1moveX);
		System.out.println(enemy2moveX);
		System.out.println(enemy3moveX);
		System.out.println(enemy4moveX);
		System.out.println(enemy5moveX);
